function PER = QAM64(EsTx,N0,H,M)
    ...
    XR((QAM_bits(:,1) == 1)&(QAM_bits(:,2) == 0)&(QAM_bits(:,3) == 0)) = 7/2*d;
    
    XI((QAM_bits(:,4) == 0)&(QAM_bits(:,5) == 0)&(QAM_bits(:,6) == 0)) = -7/2*d;
    XI((QAM_bits(:,4) == 0)&(QAM_bits(:,5) == 0)&(QAM_bits(:,6) == 1)) = -5/2*d;
    XI((QAM_bits(:,4) == 0)&(QAM_bits(:,5) == 1)&(QAM_bits(:,6) == 1)) = -3/2*d;
    XI((QAM_bits(:,4) == 0)&(QAM_bits(:,5) == 1)&(QAM_bits(:,6) == 0)) = -1/2*d;
    XI((QAM_bits(:,4) == 1)&(QAM_bits(:,5) == 1)&(QAM_bits(:,6) == 0)) = 1/2*d;
    XI((QAM_bits(:,4) == 1)&(QAM_bits(:,5) == 1)&(QAM_bits(:,6) == 1)) = 3/2*d;
    XI((QAM_bits(:,4) == 1)&(QAM_bits(:,5) == 0)&(QAM_bits(:,6) == 1)) = 5/2*d;
    XI((QAM_bits(:,4) == 1)&(QAM_bits(:,5) == 0)&(QAM_bits(:,6) == 0)) = 7/2*d;
    ...
    recv_bits(ZR < 0,1) = 0;
    recv_bits(ZR > 0,1) = 1;
    recv_bits(or(abs(ZR) == 7/2*d,abs(ZR) == 5/2*d),2) = 0;
    recv_bits(or(abs(ZR) == 3/2*d,abs(ZR) == 1/2*d),2) = 1;
    recv_bits(or(abs(ZR) == 7/2*d,abs(ZR) == 1/2*d),3) = 0;
    recv_bits(or(abs(ZR) == 5/2*d,abs(ZR) == 3/2*d),3) = 1;
    recv_bits(ZI < 0,4) = 0;
    recv_bits(ZI > 0,4) = 1;
    recv_bits(or(abs(ZI) == 7/2*d,abs(ZI) == 5/2*d),5) = 0;
    recv_bits(or(abs(ZI) == 3/2*d,abs(ZI) == 1/2*d),5) = 1;
    recv_bits(or(abs(ZI) == 7/2*d,abs(ZI) == 1/2*d),6) = 0;
    recv_bits(or(abs(ZI) == 5/2*d,abs(ZI) == 3/2*d),6) = 1;    
